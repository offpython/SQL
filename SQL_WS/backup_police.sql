...
INSERT INTO `police_station` VALUES ('서울특별시경찰철','서울시 종로구 사직로 8길 31'),('서울중부경찰서','서울시 중구 수표로 27'),('서울종로경찰서','서울시 종로구 율곡로 46'),('서울남대문경찰서','서울시 중구 한강대로 410');
...
-- Dump completed on 2023-06-28  2:36:49
